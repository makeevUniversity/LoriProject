...
public class JsonHelper {
    ...
    public JSONObject getJsonTimeEntryAdd(String strDate, String taskId, String userId, String timeInHours, String timeInMinutes, String description) {
        ...
        try {
            ...
            timeEntry.put("description",description);
    ...
    public JSONObject getJsonTimeEntryUpdate(String id,String strDate, String taskId, String userId, String timeInHours, String timeInMinutes, String description) {
